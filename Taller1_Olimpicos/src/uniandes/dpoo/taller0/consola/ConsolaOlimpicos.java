...

{
	 ...
	 * repite hasta que eld usuario seleccione la opción de abandonar la aplicación.
	 */
	...
	public void mostrarMenu()
	{
		...
		System.out.println("15. Consultar el país al que pertenece un jugador dado: ");
	...
	private void paises()
	{
		...
		String pais = input("Por favor ingrese el nombre del atleta ");
		Pais respuesta = calculadora.nompais(pais);
		System.out.println("el nombre del país es: "+respuesta);
